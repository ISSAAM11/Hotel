...
//      user.email ? this.sendEmail(user) : null;
  ...
  async login(
    ...
    if (user.role != 2 ){
      throw new HttpErrors.UnprocessableEntity('C est un compte hotel vous ne pouvez pas se connecter ici');
    }
 ...
 */   
  ...
  async replaceByIdOneAttribute(
    ...
    })newUser = { username: "", contact:"", telephone: "", email: "", hotelNumber: 0 , enable: false}
  ): Promise<void> {
